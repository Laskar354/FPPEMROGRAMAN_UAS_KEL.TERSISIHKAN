...
namespace AbstractClass
{
    public class Program
    {
        ...
        {
            Console.WriteLine("Kelompok\t\t: TERSISIHKAN");
            Console.WriteLine();
            Console.WriteLine("Nama\t\t: LA ODE MUHAMAD LASKAR JIHAD");
            Console.WriteLine("NIM\t\t: 19.11.2817");
            Console.WriteLine("Kelas\t\t: 19 IF 04");
            Console.WriteLine();
            Console.WriteLine("Nama\t\t: YAHYA ARDIANTO");
            Console.WriteLine("NIM\t\t: 19.11.2818");
            Console.WriteLine("Kelas\t\t: 19 IF 04");
            Console.WriteLine();
            Console.WriteLine("Nama\t\t: MUHAMMAD FARHAN ANGGAR");
            Console.WriteLine("NIM\t\t: 19.11.2842");
            Console.WriteLine("Kelas\t\t: 19 IF 04");
            Console.WriteLine();
            Console.WriteLine("Nama\t\t: KRISNA WIJAYA");
            Console.WriteLine("NIM\t\t: 19.11.2855");
            Console.WriteLine("Kelas\t\t: 19 IF 04");
